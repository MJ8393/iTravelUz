...
//                pageSegmentedControl.sendActions(for: UIControl.Event.valueChanged)
        ...
        get {
            ...
            return 0 // pageSegmentedControl.selectedSegmentIndex < 0 ? 0 : pageSegmentedControl.selectedSegmentIndex
        }
    }
    ...
    var pageSegmentedControl = CustomSegmentControl() // UIControl & DTSegmentedControlProtocol
...
//        pageSegmentedControl = DTSegmentedControl(items: [])
    ...
    open override func viewDidLayoutSubviews() {
        ...
        pageSegmentedControl.backgroundColor = .red
...
//        pageSegmentedControl.setImage(image, forSegmentAt: segment)
    ...
    func setUpPageScrollView() {
        ...
        pageScrollView.frame = CGRect(x: 0, y: segmentedControlHeight, width: size.width, height: size.height)
