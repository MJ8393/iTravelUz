...
public class SiriWaveView: UIView {
    ...
    @IBInspectable
    public var idleAmplitude: CGFloat = 0.5
    @IBInspectable
    public var speed: CGFloat = 0.15

    public var colors: [UIColor] = [UIColor(rgb: 0x6313FF),
                                    UIColor(rgb: 0xAC81FF),
                                    UIColor(rgb: 0x7F3DFF)]
